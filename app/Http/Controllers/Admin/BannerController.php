...
class BannerController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.banner.add',compact('categories','service_providers','consultclasses','users'));
    }
    ...
    public function store(Request $request)
    {
         ...
         $validator = \Validator::make($request->all(),$rule,$msg);
          ...
          $banner->user_id = isset($input['user']) ? $input['user'] : NULL;
    ...
    public function edit(Banner $banner)
    {
        ...
        return view('admin.banner.edit',compact('categories','service_providers','consultclasses','banner','users'));
    }
