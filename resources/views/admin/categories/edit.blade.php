                            ...
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              <input type="hidden" name="_method" value="put">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="text" value="{{ old('percentage')??$category->percentage }}" name="percentage" />
                                ...
                                <div class="col-md-6">
                                      ...
                                      <select class="form-control show-tick" name="enable_percentage">
                                        <option <?php echo (old('enable_percentage')=='1' || $category->enable_percentage=='1')?"selected":'' ?> value="1">Yes</option>
                                        <option <?php echo (old('enable_percentage')=='0' || $category->enable_percentage=='0')?"selected":'' ?> value="0">No</option>
                                      </select>
                                  ...
                                  <tbody>
                                   @foreach($category->filters as $index => $filtertype)
                                    <tr>
                                      ...
                                      @if(config('client_connected') && Config::get("client_data")->domain_name=="care_connect_live")
                                      <td>{{ $filtertype->input_type }}</td>
                                      <td>{{ ($filtertype->input_type=='textbox')?$filtertype->data_type:'' }}</td>
                                    @else
                                      <td>{{ ($filtertype->is_multi=='1')?"Yes":"No" }}</td>
                                    @endif
                                      <td>{{ ($filtertype->input_type!=='textbox')?$filtertype->options->pluck('option_name'):'NA' }}
                                      </td>
