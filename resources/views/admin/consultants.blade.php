			            ...
			            <tr class="delete_row">
			              ...
			              <td>
			              	<ul style="padding: initial;">
			              		...
			              		<li title="Password Update" style="display:inline-block;"><button data-user_id="{{ $consultant->id }}" data-user_name="{{ $consultant->name }}" class="btn btn-sm btn-success openPasswordModal"><i class="fas fa-key"></i></button>
			              		</li>
