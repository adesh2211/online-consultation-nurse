      ...
      <input type="hidden" name="_method" value="POST">
        ...
        @endif
          <div class="form-group">
            ...
            <input type="email" class="form-control" name="email" value="{{ old('email') }}" id="exampleInputEmail1" placeholder="Enter email" autocomplete="off">
            @if ($errors->has('email'))
          ...
          <div class="form-group">
            ...
            <input type="password" name="password" class="form-control" value="{{ old('password') }}" id="password" placeholder="password" autocomplete="off">
