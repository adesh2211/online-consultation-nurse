          ...
          <div class="row">
            ...
            <div class="col-sm-6">
                      ...
                      <select  class="form-control" name="app_type">
                        <option value="both" <?php echo ($page->app_type=='both')?"selected":'' ?>>Both</option>
                        <option value="customer" <?php echo ($page->app_type=='customer')?"selected":'' ?>>Customer</option>
                        <option value="service_provider" <?php echo ($page->app_type=='service_provider')?"selected":'' ?>>Service Provider</option>
                      </select>
                      @if($errors->any())
