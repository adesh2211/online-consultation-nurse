...
<div class="navbar-custom">
    ...
    <!-- 
           ...
           <!--  <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
            ...
            @if(Auth::user()->hasrole('doctor_manager'))
             @php
            ...
            @endphp
             <li class="dropdown notification-list topbar-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-lg">
                    ...
                    @endphp
                        <a href="javascript:void(0);" class="dropdown-item notify-item active noifi">
                            <div class="notify-icon">
                            @if($sender->profile_image == '' || $sender->profile_image == Null)
                            <img style="float:left; heigth:50px !important; width:50px;" src="{{asset('assets/care_connect_live/images/ic_upload profile img.png')}}" class="img-fluid rounded-circle" alt="">
                            @else
                            <img style="float:left; heigth:50px !important; width:50px;" src="{{ Storage::disk('spaces')->url('thumbs/'.$sender->profile_image) }}" class="img-fluid rounded-circle"  alt="">
                            @endif
                            
                            <p class="notify-details">{{ucwords($sender->name)}}</p>
                            <p class="text-muted mb-0 user-msg">
                                <small>{{$notification->message}}</small>
                            </p>
                            @if($notification->notification_type == 'JOIN_REQUEST')
                            <div class="accept_btn">
                            <a target=_blank href="https://meet.inhomed.com/Call_202001_{{$notification->module_id}}" class="btn btn-primary" >Accept</a>
                            </div>
                            @endif
                        </a>
        ...
        <div class="logo-box">
            ...
            <a href="" class="logo logo-light text-center">
                ...
                <span class="logo-sm">
                    <img src="{{ asset('assets/images/'.$image_name.'.png') }}" alt="" height="32">
                </span>
                <span class="logo-lg">
                    <img src="{{ asset('assets/images/'.$image_name.'.png')}}"alt="" height="64">
                </span>
                @else
                <span class="logo-sm">
