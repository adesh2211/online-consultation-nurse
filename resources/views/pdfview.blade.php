...
<body style="">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12" style="background: {{ ($requesttable->background_color)?$requesttable->background_color:'#31398F' }}; padding: 20px;">
				<div class="row">
			...
			<section class="table-section">
					...
					@foreach($requesttable->images as $img)
						...
						<div style="height:auto;width:100%;overflow:hidden;padding:10px 0px 10px 0px;">
							<img src="{{ Storage::disk('spaces')->url('uploads/'.$img->image_name) }}" style="width:100%;height:auto;object-fit:cover !important;">
						</div>
					@endforeach
				</section>
			@endif
			...
			<div class="col-12 footer-block" style="margin: 0 -30px; background: {{ ($requesttable->background_color)?$requesttable->background_color:'#31398F' }}; padding: 12px 20px; margin-top: 60px;">
				<div class="row">
					<div class="col-6">
